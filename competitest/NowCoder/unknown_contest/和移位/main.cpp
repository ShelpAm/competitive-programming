...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/121107/F
// Start: Sat 08 Nov 2025 03:17:27 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    std::map<int, std::pair<int, int>> mp; // at least 1 contrib
    for (int k{}; k != n; ++k) {
        std::map<int, int> o;
        for (int i{}; i != n; ++i) {
            ++o[a[i] + a[(i - k + n) % n]];
