...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/118113/I
// Start: Sat 27 Sep 2025 01:06:42 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    auto cnt = std::ranges::count_if(a, [](auto e) { return e > 0; });
    std::cout << (cnt == n || cnt == 0 ? "Yes\n" : "No\n");
}
