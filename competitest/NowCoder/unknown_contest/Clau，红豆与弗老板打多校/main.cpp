...
// Problem: Clau，红豆与弗老板打多校
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/121107/E
// Start: Sat 08 Nov 2025 02:18:00 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    std::ranges::sort(a, {},
                      [](auto e) { return std::pair{-e.first, e.second}; });

    auto r = std::ranges::find(a, t) - a.begin();
    std::cout << (r <= n / 10       ? "gold"
                  : r <= n * 3 / 10 ? "silver"
                  : r <= n * 6 / 10 ? "bronze"
                                    : "iron")
              << '\n';
