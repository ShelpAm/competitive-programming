...
// Contest: Panasonic Programming Contest 2025（AtCoder Beginner Contest 427）
// Judge: AtCoder
// URL: https://atcoder.jp/contests/abc427/tasks/abc427_d
// Start: Wed 29 Oct 2025 10:09:25 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    std::map<std::pair<int, int>, int> sg_;
    std::function<int(int, int)> sg = [&](int l, int u) -> int {
        if (sg_.contains({l, u})) {
            return sg_[{l, u}];
        }
        if (l == 0) {
