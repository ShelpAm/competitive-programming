...
// Problem: M. V-Diagram
// Contest: The 2023 ICPC Asia Hangzhou Regional Contest (The 2nd Universal Cup.
// Stage 22: Hangzhou) Judge: Codeforces URL:
// https://codeforces.com/gym/104976/problem/M Start: Thu 09 Oct 2025 06:41:37
...
void solve_case()
{
    ...
    auto i = std::ranges::min_element(a) - a.begin();
    double ans{};
    chmax(ans, std::accumulate(a.begin(), a.begin() + i + 2, 0LL) /
                   static_cast<double>(i + 2));
    chmax(ans, std::accumulate(a.begin() + i - 1, a.end(), 0LL) /
                   static_cast<double>(n - i + 1));
    chmax(ans,
          std::accumulate(a.begin(), a.end(), 0LL) / static_cast<double>(n));
    std::cout << ans << '\n';
}
